...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            num_heads: number of attention heads.
      4      mlp_ratio: ratio of mlp hidden dim to embedding dim.
            qkv_bias: add a learnable bias to query, key, value.
...
class SegformerMLP(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor):
        # print("hidden_states before reshape", hidden_states.shape)
        hidden_states = hidden_states.flatten(2).transpose(1, 2)
        # print("hidden_states after reshape", hidden_states.shape)
        hidden_states = self.proj(hidden_states)
        # print("hidden_states after projection", hidden_states.shape)
...
class SwinSegFormerEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.encoder0_1 = UnetrBasicBlock(
            spatial_dims=spatial_dims,
    ...
    def forward(self, x_in):
        ...
        # print("x_in.shape ffd", x_in.shape)
        enc0 = self.encoder0_1(self.encoder0(x_in) )
        # print("enc0.shape", enc0.shape)
        ...
        # print("enc1.shape out put of hidden_states_out[0]", enc1.shape)
        enc2 = self.encoder2(hidden_states_out[1])
        # print("enc2.shapeout put of hidden_states_out[1]", enc2.shape)
        enc3 = self.encoder3(hidden_states_out[2])
        # print("enc3.shape out put of hidden_states_out[2]", enc3.shape)
        enc4 = self.encoder4(hidden_states_out[3])
        # print("enc4.shape out put of hidden_states_out[3]", enc4.shape)
        # print("Flag----------------------------------------------")
        # enc5 = self.encoder5(hidden_states_out[4])
        # print("enc5.shape out put of hidden_states_out[3]", enc5.shape)
        ...
        encoder_hidden_states = (enc0,enc1, enc2, enc3, enc4 ) ## ,enc4, enc5
        logits = self.SegformerDecodeHead(encoder_hidden_states)
        # dec2 = self.decoder4(dec3, enc3)
        # dec1 = self.decoder3(dec2, enc2)
        # dec0 = self.decoder2(dec1, enc1)
        # out = self.decoder1(dec0, enc0)
        # print("shape of before last layer", out.shape)
        # logits = self.out(out)
        # print("shape of last layer", logits.shape)
        return logits
